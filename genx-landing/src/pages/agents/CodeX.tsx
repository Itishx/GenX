    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <main className="pt-24">
        <section className="mx-auto max-w-7xl px-6 py-10">
          ...
          >
            Your coding copilot for rapid prototyping, refactors, reviews, and test generation.
          </motion.p>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] shadow-2xl">
              ...
              />
              <div className="pointer-events-none absolute -inset-px rounded-2xl bg-gradient-to-br from-indigo-600/30 to-fuchsia-600/20" />
            </div>
          </motion.div>
        </section>
      </main>
