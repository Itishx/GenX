      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-[#111111] leading-tight mb-6 max-w-lg" style={{ fontFamily: "'Neue Haas Display', serif" }}>
            ...
            <div className="space-y-0">
              <motion.div variants={itemVariants} whileHover={{ paddingLeft: 8 }} className="border-t border-[#eaeaea] py-6 cursor-pointer group transition-all">
                <h4 className="text-[#111111] font-medium text-lg mb-2 group-hover:text-[#ff5a00] transition">Adaptive Intelligence</h4>
              ...
              <motion.div variants={itemVariants} whileHover={{ paddingLeft: 8 }} className="border-t border-[#eaeaea] py-6 cursor-pointer group transition-all">
                <h4 className="text-[#111111] font-medium text-lg mb-2 group-hover:text-[#ff5a00] transition">Multi-Model Engine</h4>
                <p className="text-[#555555] text-base leading-relaxed">
              ...
              <motion.div variants={itemVariants} whileHover={{ paddingLeft: 8 }} className="border-t border-[#eaeaea] py-6 border-b cursor-pointer group transition-all">
                <h4 className="text-[#111111] font-medium text-lg mb-2 group-hover:text-[#ff5a00] transition">Founder-First Design</h4>
                <p className="text-[#555555] text-base leading-relaxed">
